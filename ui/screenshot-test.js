...
async function run() {
  ...
  // 1. Login page
  await pageDL.goto('http://localhost:2399/auth/login', { waitUntil: 'networkidle', timeout: 15000 });
  ...
  // 2. Registration page
  await pageDL.goto('http://localhost:2399/auth/registration', { waitUntil: 'networkidle', timeout: 15000 });
  await pageDL.waitForTimeout(1000);
  ...
  await pageDD.goto('http://localhost:2399/auth/login', { waitUntil: 'networkidle', timeout: 15000 });
  ...
  // 4. Registration dark
  await pageDD.goto('http://localhost:2399/auth/registration', { waitUntil: 'networkidle', timeout: 15000 });
  ...
  await pageML.goto('http://localhost:2399/auth/login', { waitUntil: 'networkidle', timeout: 15000 });
  ...
  await pageMD.goto('http://localhost:2399/auth/login', { waitUntil: 'networkidle', timeout: 15000 });
